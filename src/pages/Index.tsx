    ...
    const handleToggle = async () => {
        if (isRunning && timeThresholdMet) {
            ...
            if (isAuthenticated) {
                ...
                toast({
                    title: "Saving Score",
                    description: success ? "Your score has been saved successfully." : "Failed to save score.",
                })
            } else {
                setShowSaveDialog(true);
            }
            ...
            <div className="w-full max-w-xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate-scale-in">
                    <Card className="p-4 rounded-xl bg-secondary/50 shadow-sm backdrop-blur-sm">
                        ...
                        <div className="text-2xl font-semibold">{accelerometerData.currentSpeed.toFixed(1)} <span
                            className="text-sm font-normal">km/h</span></div>
                    </Card>
                    ...
                    <Card className="p-4 rounded-xl bg-secondary/50 shadow-sm backdrop-blur-sm">
                        ...
                        <div className="text-2xl font-semibold">{accelerometerData.topSpeed.toFixed(1)} <span
                            className="text-sm font-normal">km/h</span></div>
                    </Card>
                    ...
                    <Card className="p-4 rounded-xl bg-secondary/50 shadow-sm backdrop-blur-sm">
                        ...
                        <div className="text-2xl font-semibold">{accelerometerData.averageSpeed.toFixed(1)} <span
                            className="text-sm font-normal">km/h</span></div>
                    </Card>
                </div>
